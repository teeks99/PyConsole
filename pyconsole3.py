"""A Python3, tk-based console for conversing with the Python interpreter,
...
This file is based on https://github.com/teeks99/PyConsole. 
...
class Console(tk.Frame):
	def __init__(self, parent=None, dict={}, **kwargs):
	...
	def config(self, *args, **kwargs):
		"""Get or set configuration options in a tk-like style."""
		if args == () and kwargs == {}:
			return self.options
		if len(args) == 1:
	...
	def precontext(self):
		...
		startchars = string.ascii_letters + "_"
	...
	def postmenus(self, keys, skip, cut, object):
		...
		menu = tk.Menu(font=menufont, bd=1, tearoff=0)
	...
	def cb_help(self, event):
		...
		if doc:
			...
			help = tk.Menu(font=menufont, bd=1, tearoff=0)
			try:
